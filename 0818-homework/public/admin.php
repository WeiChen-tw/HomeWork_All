            ...
            <div class="col-sm-4">
                <div>
                    <h1><?= "AdminName:".$_SESSION["userName"]?><br>
                        <a class="btn btn-danger" href="login.php?logout=1" >登出 </a>
                        <a class="btn btn-success" href="index.php" >回首頁 </a>                           
                ...
                <ul id="latestNews" class="list-group">
                    <?php foreach ($statement as $row) { ?>
                        <li class="bgc-admin list-group-item"><?= $row['title'] . " [" . $row['ymd'] . "]" ?><span class="pull-right"><button class="btn btn-info btn-xs editItem"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>&nbsp;
                                <button class="btn btn-primary btn-xs newImage"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span></span></button>&nbsp;
                            <button class="btn btn-danger btn-xs deleteItem"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></span></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="col-sm-4">
